...
class PerformanceDetermination:
    ...
    def extract_annotations_from_files(self, path, tagname,srclang_list, manual_obfuscation_type):
        ...
        for xmlfile in xmlfiles:
            annotations.update(self.extract_annotations_from_file(xmlfile, tagname,srclang_list,manual_obfuscation_type))
        return annotations


    def extract_annotations_from_file(self, xmlfile, tagname, srclang_list, manual_obfuscation_type):
    ...
    def parse_options(self):
        ...
        if det_path == "undefined":
            ...
            sys.exit()
        return (micro_averaged, plag_path, plag_tag_name, det_path, det_tag_name, srclang_path,lang, obfuscation)


    def main(self, micro_averaged, plag_path, plag_tag_name, det_path, det_tag_name,srclang_path,lang, obfuscation):
        ...
        cases = self.extract_annotations_from_files(plag_path, plag_tag_name,srclang_list,manual_obfuscation_type)
        print('Reading ' + det_path)
        detections = self.extract_annotations_from_files(det_path, det_tag_name,srclang_list, manual_obfuscation_type)
